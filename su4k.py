...
mulai = time.time() 
dangerMessage = ["cleanse","group cleansed.","mulai",".winebot",".kickall","mayhem","kick on","makasih :d","!kickall","nuke","บิน","เตะ","อีชิ","ควย","สัส","เชี้ย","ไอ้ควาย","ไอ้เหี้ย","ไอ้เชี้ย","อีสัส","ไอ้สัส","พร้อง","พ่อง","ไอ้ควย","ควาย","พ่องตาย","พร่อง"]
